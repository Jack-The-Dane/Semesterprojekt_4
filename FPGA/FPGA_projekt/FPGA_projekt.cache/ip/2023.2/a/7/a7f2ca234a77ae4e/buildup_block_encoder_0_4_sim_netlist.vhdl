...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_up_down_counter is
  ...
  attribute SOFT_HLUTNM of \int_cnt[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \int_cnt[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \int_cnt[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \int_cnt[4]_i_2\ : label is "soft_lutpair0";
...
\int_cnt[4]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\int_cnt[5]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\int_cnt[8]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
\int_cnt[8]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_block_encoder is
  signal Rising_edge_a_n_0 : STD_LOGIC;
