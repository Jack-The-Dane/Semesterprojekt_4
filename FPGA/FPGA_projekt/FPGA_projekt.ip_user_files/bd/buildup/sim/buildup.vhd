...
pan_encoder: component buildup_block_encoder_0_0
     port map (
      clk => clk_1,
...
tilt_encoder: component buildup_block_encoder_1_0
     port map (
      clk => clk_1,
      enable => xlconstant_1_dout(0),
