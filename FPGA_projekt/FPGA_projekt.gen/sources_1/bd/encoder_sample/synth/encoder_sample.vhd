...
architecture STRUCTURE of encoder_sample is
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_RESET ja_2, CLK_DOMAIN encoder_sample_clk_0, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
  attribute X_INTERFACE_INFO of ja_2 : signal is "xilinx.com:signal:reset:1.0 RST.JA_2 RST";
  attribute X_INTERFACE_PARAMETER of ja_2 : signal is "XIL_INTERFACENAME RST.JA_2, INSERT_VIP 0, POLARITY ACTIVE_LOW";
begin
  clk_0_1 <= clk;
  enc_a_0_1 <= ja_0;
  enc_b_0_1 <= ja_1;
