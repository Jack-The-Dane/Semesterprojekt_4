...
architecture STRUCTURE of pwm_generator_counter_1_0_counter is
  ...
  signal \cnt_int_reg[26]_i_1_n_2\ : STD_LOGIC;
  signal \cnt_int_reg[26]_i_1_n_3\ : STD_LOGIC;
  signal \cnt_int_reg[26]_i_1_n_5\ : STD_LOGIC;
  signal \cnt_int_reg[26]_i_1_n_6\ : STD_LOGIC;
  signal \cnt_int_reg[26]_i_1_n_7\ : STD_LOGIC;
  ...
  signal \NLW_cnt_int_reg[26]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_cnt_int_reg[26]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute ADDER_THRESHOLD of \cnt_int_reg[26]_i_1\ : label is 11;
...
\cnt_int_reg[26]\: unisim.vcomponents.FDCE
    generic map(
      ...
      CE => en,
      CLR => rst,
      D => \cnt_int_reg[26]_i_1_n_5\,
      Q => \^cnt\(26)
    );
\cnt_int_reg[26]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \cnt_int_reg[23]_i_1_n_0\,
      CO(3 downto 2) => \NLW_cnt_int_reg[26]_i_1_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \cnt_int_reg[26]_i_1_n_2\,
      CO(0) => \cnt_int_reg[26]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_cnt_int_reg[26]_i_1_O_UNCONNECTED\(3),
      O(2) => \cnt_int_reg[26]_i_1_n_5\,
      O(1) => \cnt_int_reg[26]_i_1_n_6\,
      O(0) => \cnt_int_reg[26]_i_1_n_7\,
      S(3) => '0',
