...
-- Command     : write_vhdl -force -mode funcsim -rename_top buildup_block_encoder_0_3 -prefix
--               buildup_block_encoder_0_3_ buildup_block_encoder_0_4_sim_netlist.vhdl
...
entity buildup_block_encoder_0_3_Rising_edge_detector is
  port (
...
end buildup_block_encoder_0_3_Rising_edge_detector;

architecture STRUCTURE of buildup_block_encoder_0_3_Rising_edge_detector is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity buildup_block_encoder_0_3_Rising_edge_detector_0 is
  port (
    FF1 : out STD_LOGIC;
    FF2 : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of buildup_block_encoder_0_3_Rising_edge_detector_0 : entity is "Rising_edge_detector";
end buildup_block_encoder_0_3_Rising_edge_detector_0;

architecture STRUCTURE of buildup_block_encoder_0_3_Rising_edge_detector_0 is
  signal \^ff1\ : STD_LOGIC;
  signal \^ff2\ : STD_LOGIC;
begin
  FF1 <= \^ff1\;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity buildup_block_encoder_0_3_up_down_counter is
  port (
...
end buildup_block_encoder_0_3_up_down_counter;

architecture STRUCTURE of buildup_block_encoder_0_3_up_down_counter is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity buildup_block_encoder_0_3_block_encoder_Rising_edge_a_0 is
  port (
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
    encoder_b : in STD_LOGIC;
    clk : in STD_LOGIC;
...
end buildup_block_encoder_0_3_block_encoder_Rising_edge_a_0;

architecture STRUCTURE of buildup_block_encoder_0_3_block_encoder_Rising_edge_a_0 is
begin
U0: entity work.buildup_block_encoder_0_3_Rising_edge_detector
     port map (
      E(0) => E(0),
      clk => clk,
      enable => enable,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity buildup_block_encoder_0_3_block_encoder_Rising_edge_detector_0_0 is
  port (
    FF1 : out STD_LOGIC;
    FF2 : out STD_LOGIC;
...
end buildup_block_encoder_0_3_block_encoder_Rising_edge_detector_0_0;

architecture STRUCTURE of buildup_block_encoder_0_3_block_encoder_Rising_edge_detector_0_0 is
begin
U0: entity work.buildup_block_encoder_0_3_Rising_edge_detector_0
     port map (
      FF1 => FF1,
      FF2 => FF2,
      FF2_reg_0 => FF2_reg,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity buildup_block_encoder_0_3_block_encoder_up_down_counter_0_0 is
  port (
    Q : out STD_LOGIC_VECTOR ( 8 downto 0 );
...
end buildup_block_encoder_0_3_block_encoder_up_down_counter_0_0;

architecture STRUCTURE of buildup_block_encoder_0_3_block_encoder_up_down_counter_0_0 is
begin
U0: entity work.buildup_block_encoder_0_3_up_down_counter
     port map (
      E(0) => E(0),
      FF1 => FF1,
      FF2 => FF2,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity buildup_block_encoder_0_3_block_encoder is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    encoder_a : in STD_LOGIC;
  ...
  attribute hw_handoff of buildup_block_encoder_0_3_block_encoder : entity is "block_encoder.hwdef";
end buildup_block_encoder_0_3_block_encoder;

architecture STRUCTURE of buildup_block_encoder_0_3_block_encoder is
...
begin
Rising_edge_a: entity work.buildup_block_encoder_0_3_block_encoder_Rising_edge_detector_0_0
     port map (
      FF1 => \U0/FF1\,
      FF2 => \U0/FF2\,
...
Rising_edge_b: entity work.buildup_block_encoder_0_3_block_encoder_Rising_edge_a_0
     port map (
...
up_down_counter_0: entity work.buildup_block_encoder_0_3_block_encoder_up_down_counter_0_0
     port map (
      E(0) => Rising_edge_b_n_0,
      FF1 => \U0/FF1\,
      FF2 => \U0/FF2\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity buildup_block_encoder_0_3 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    encoder_a : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of buildup_block_encoder_0_3 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of buildup_block_encoder_0_3 : entity is "buildup_block_encoder_0_4,block_encoder,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of buildup_block_encoder_0_3 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of buildup_block_encoder_0_3 : entity is "IPI";
  attribute x_core_info : string;
  attribute x_core_info of buildup_block_encoder_0_3 : entity is "block_encoder,Vivado 2023.2";
end buildup_block_encoder_0_3;

architecture STRUCTURE of buildup_block_encoder_0_3 is
  attribute hw_handoff : string;
  attribute hw_handoff of U0 : label is "block_encoder.hwdef";
begin
U0: entity work.buildup_block_encoder_0_3_block_encoder
     port map (
      clk => clk,
      enable => enable,
      encoder_a => encoder_a,
