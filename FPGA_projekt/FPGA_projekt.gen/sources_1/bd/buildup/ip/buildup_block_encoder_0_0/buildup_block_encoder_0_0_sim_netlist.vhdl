...
--               buildup_block_encoder_0_0_ buildup_block_encoder_0_1_sim_netlist.vhdl
...
entity buildup_block_encoder_0_0_Rising_edge_detector is
  port (
...
end buildup_block_encoder_0_0_Rising_edge_detector;

architecture STRUCTURE of buildup_block_encoder_0_0_Rising_edge_detector is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity buildup_block_encoder_0_0_Rising_edge_detector_0 is
  port (
  ...
  attribute ORIG_REF_NAME of buildup_block_encoder_0_0_Rising_edge_detector_0 : entity is "Rising_edge_detector";
end buildup_block_encoder_0_0_Rising_edge_detector_0;

architecture STRUCTURE of buildup_block_encoder_0_0_Rising_edge_detector_0 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity buildup_block_encoder_0_0_block_encoder_Rising_edge_a_0 is
  port (
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
    encoder_b : in STD_LOGIC;
    clk : in STD_LOGIC;
...
end buildup_block_encoder_0_0_block_encoder_Rising_edge_a_0;

architecture STRUCTURE of buildup_block_encoder_0_0_block_encoder_Rising_edge_a_0 is
begin
U0: entity work.buildup_block_encoder_0_0_Rising_edge_detector
     port map (
      E(0) => E(0),
      clk => clk,
      enable => enable,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity buildup_block_encoder_0_0_block_encoder_Rising_edge_detector_0_0 is
  port (
    FF1 : out STD_LOGIC;
    FF2 : out STD_LOGIC;
    D : out STD_LOGIC_VECTOR ( 0 to 0 );
...
end buildup_block_encoder_0_0_block_encoder_Rising_edge_detector_0_0;

architecture STRUCTURE of buildup_block_encoder_0_0_block_encoder_Rising_edge_detector_0_0 is
begin
U0: entity work.buildup_block_encoder_0_0_Rising_edge_detector_0
     port map (
      D(0) => D(0),
      FF1_reg_0 => FF1,
      FF2 => FF2,
...
Rising_edge_a: entity work.buildup_block_encoder_0_0_block_encoder_Rising_edge_detector_0_0
     port map (
      D(0) => p_0_in(1),
      FF1 => \U0/FF1\,
      FF2 => \U0/FF2\,
...
Rising_edge_b: entity work.buildup_block_encoder_0_0_block_encoder_Rising_edge_a_0
     port map (
...
entity buildup_block_encoder_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of buildup_block_encoder_0_0 : entity is "buildup_block_encoder_0_1,block_encoder,{}";
