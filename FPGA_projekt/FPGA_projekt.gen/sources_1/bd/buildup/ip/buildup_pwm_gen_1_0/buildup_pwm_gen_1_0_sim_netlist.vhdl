...
-- Command     : write_vhdl -force -mode funcsim -rename_top buildup_pwm_gen_1_0 -prefix
--               buildup_pwm_gen_1_0_ design_1_pwm_gen_1_0_sim_netlist.vhdl
...
entity buildup_pwm_gen_1_0_pwm_gen is
  port (
    pwm : out STD_LOGIC;
    duty : in STD_LOGIC_VECTOR ( 7 downto 0 );
    cnt : in STD_LOGIC_VECTOR ( 7 downto 0 )
  );
end buildup_pwm_gen_1_0_pwm_gen;

architecture STRUCTURE of buildup_pwm_gen_1_0_pwm_gen is
...
entity buildup_pwm_gen_1_0 is
  ...
  attribute NotValidForBitStream of buildup_pwm_gen_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of buildup_pwm_gen_1_0 : entity is "design_1_pwm_gen_1_0,pwm_gen,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of buildup_pwm_gen_1_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of buildup_pwm_gen_1_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of buildup_pwm_gen_1_0 : entity is "pwm_gen,Vivado 2023.2";
end buildup_pwm_gen_1_0;

architecture STRUCTURE of buildup_pwm_gen_1_0 is
begin
U0: entity work.buildup_pwm_gen_1_0_pwm_gen
     port map (
