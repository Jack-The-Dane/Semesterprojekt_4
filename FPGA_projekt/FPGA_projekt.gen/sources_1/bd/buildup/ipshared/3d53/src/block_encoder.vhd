...
architecture STRUCTURE of block_encoder is
  ...
  component block_encoder_Rising_edge_detector_0_0 is
  port (
    clk : in STD_LOGIC;
    D : in STD_LOGIC;
    Q : out STD_LOGIC
  );
  end component block_encoder_Rising_edge_detector_0_0;
  component block_encoder_Rising_edge_a_0 is
  port (
    clk : in STD_LOGIC;
    D : in STD_LOGIC;
    Q : out STD_LOGIC
  );
  end component block_encoder_Rising_edge_a_0;
  signal AND_gate_0_C : STD_LOGIC;
  signal AND_gate_1_C : STD_LOGIC;
  signal NOT_gate_0_B : STD_LOGIC;
  signal NOT_gate_b_B : STD_LOGIC;
  signal Rising_edge_a_Q : STD_LOGIC;
  signal Rising_edge_b_Q : STD_LOGIC;
...
Rising_edge_a: component block_encoder_Rising_edge_detector_0_0
     port map (
      D => encoder_a_1,
      Q => Rising_edge_a_Q,
      clk => clk_1
    );
Rising_edge_b: component block_encoder_Rising_edge_a_0
     port map (
      D => encoder_b_1,
      Q => Rising_edge_b_Q,
      clk => clk_1
