...
entity buildup is
  port (
    SPI_out_0 : out STD_LOGIC_VECTOR ( 15 downto 0 );
    btn_0 : in STD_LOGIC;
    btn_1 : in STD_LOGIC;
    btn_2 : in STD_LOGIC;
    clk : in STD_LOGIC;
...
begin
  SPI_out_0(15 downto 0) <= SPI_0_SPI_out(15 downto 0);
  btn_0_1 <= btn_0;
  btn_1_1 <= btn_1;
  btn_2_1 <= btn_2;
  clk_1 <= clk;
  cnt_0(15 downto 0) <= counter_0_cnt(15 downto 0);
  encoder_a_0_1 <= ja_1;
  encoder_b_0_1 <= ja_2;
  ja_0 <= pwm_gen_0_pwm;
  ja_3_1 <= ja_3;
