...
entity buildup is
  ...
  attribute CORE_GENERATION_INFO of buildup : entity is "buildup,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=buildup,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=12,numReposBlks=12,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=5,numPkgbdBlks=3,bdsource=USER,synth_mode=Hierarchical}";
...
pwm_gen_0: component buildup_pwm_gen_0_1
     port map (
      cnt(7 downto 0) => counter_0_cnt(7 downto 0),
      duty(7 downto 0) => xlslice_1_Dout(7 downto 0),
      pwm => pwm_gen_0_pwm
    );
pwm_gen_1: component buildup_pwm_gen_1_0
     port map (
      cnt(7 downto 0) => counter_0_cnt(7 downto 0),
