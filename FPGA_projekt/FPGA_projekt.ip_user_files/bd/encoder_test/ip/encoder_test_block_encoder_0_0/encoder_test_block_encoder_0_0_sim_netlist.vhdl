...
--               /home/jacob/Documents/Semester4/Semesterprojekt_4/FPGA_projekt/FPGA_projekt.gen/sources_1/bd/encoder_test/ip/encoder_test_block_encoder_0_0/encoder_test_block_encoder_0_0_sim_netlist.vhdl
...
entity encoder_test_block_encoder_0_0_edge_detector is
  port (
  ...
  attribute ORIG_REF_NAME of encoder_test_block_encoder_0_0_edge_detector : entity is "edge_detector";
end encoder_test_block_encoder_0_0_edge_detector;

architecture STRUCTURE of encoder_test_block_encoder_0_0_edge_detector is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity encoder_test_block_encoder_0_0_edge_detector_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of encoder_test_block_encoder_0_0_edge_detector_0 : entity is "edge_detector";
end encoder_test_block_encoder_0_0_edge_detector_0;

architecture STRUCTURE of encoder_test_block_encoder_0_0_edge_detector_0 is
  signal \^latch_1\ : STD_LOGIC;
  signal \^latch_2\ : STD_LOGIC;
begin
  latch_1 <= \^latch_1\;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity encoder_test_block_encoder_0_0_up_down_counter is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of encoder_test_block_encoder_0_0_up_down_counter : entity is "up_down_counter";
end encoder_test_block_encoder_0_0_up_down_counter;

architecture STRUCTURE of encoder_test_block_encoder_0_0_up_down_counter is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity encoder_test_block_encoder_0_0_block_encoder_edge_detector_0_0 is
  port (
    latch_1 : out STD_LOGIC;
    latch_2 : out STD_LOGIC;
    AND_gate_0_C : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of encoder_test_block_encoder_0_0_block_encoder_edge_detector_0_0 : entity is "block_encoder_edge_detector_0_0";
end encoder_test_block_encoder_0_0_block_encoder_edge_detector_0_0;

architecture STRUCTURE of encoder_test_block_encoder_0_0_block_encoder_edge_detector_0_0 is
begin
U0: entity work.encoder_test_block_encoder_0_0_edge_detector_0
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity encoder_test_block_encoder_0_0_block_encoder_edge_detector_0_1 is
  port (
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
    encoder_b : in STD_LOGIC;
    clk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of encoder_test_block_encoder_0_0_block_encoder_edge_detector_0_1 : entity is "block_encoder_edge_detector_0_1";
end encoder_test_block_encoder_0_0_block_encoder_edge_detector_0_1;

architecture STRUCTURE of encoder_test_block_encoder_0_0_block_encoder_edge_detector_0_1 is
begin
U0: entity work.encoder_test_block_encoder_0_0_edge_detector
     port map (
      AND_gate_0_C => AND_gate_0_C,
      E(0) => E(0),
      clk => clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity encoder_test_block_encoder_0_0_block_encoder_up_down_counter_0_0 is
  port (
    Q : out STD_LOGIC_VECTOR ( 8 downto 0 );
    encoder_b : in STD_LOGIC;
    latch_1 : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of encoder_test_block_encoder_0_0_block_encoder_up_down_counter_0_0 : entity is "block_encoder_up_down_counter_0_0";
end encoder_test_block_encoder_0_0_block_encoder_up_down_counter_0_0;

architecture STRUCTURE of encoder_test_block_encoder_0_0_block_encoder_up_down_counter_0_0 is
begin
U0: entity work.encoder_test_block_encoder_0_0_up_down_counter
     port map (
      AND_gate_0_C => AND_gate_0_C,
      E(0) => E(0),
      Q(8 downto 0) => Q(8 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity encoder_test_block_encoder_0_0_block_encoder is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    encoder_a : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of encoder_test_block_encoder_0_0_block_encoder : entity is "block_encoder";
  attribute hw_handoff : string;
  attribute hw_handoff of encoder_test_block_encoder_0_0_block_encoder : entity is "block_encoder.hwdef";
end encoder_test_block_encoder_0_0_block_encoder;

architecture STRUCTURE of encoder_test_block_encoder_0_0_block_encoder is
...
begin
edge_detector_a: entity work.encoder_test_block_encoder_0_0_block_encoder_edge_detector_0_0
     port map (
      AND_gate_0_C => AND_gate_0_C,
      clk => clk,
      encoder_a => encoder_a,
...
edge_detector_b: entity work.encoder_test_block_encoder_0_0_block_encoder_edge_detector_0_1
     port map (
      AND_gate_0_C => AND_gate_0_C,
...
up_down_counter_0: entity work.encoder_test_block_encoder_0_0_block_encoder_up_down_counter_0_0
     port map (
      AND_gate_0_C => AND_gate_0_C,
      E(0) => edge_detector_b_n_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity encoder_test_block_encoder_0_0 is
  port (
    clk : in STD_LOGIC;
    enable : in STD_LOGIC;
    encoder_a : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of encoder_test_block_encoder_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of encoder_test_block_encoder_0_0 : entity is "encoder_test_block_encoder_0_0,block_encoder,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of encoder_test_block_encoder_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of encoder_test_block_encoder_0_0 : entity is "IPI";
  attribute x_core_info : string;
  attribute x_core_info of encoder_test_block_encoder_0_0 : entity is "block_encoder,Vivado 2023.2";
end encoder_test_block_encoder_0_0;

architecture STRUCTURE of encoder_test_block_encoder_0_0 is
  attribute hw_handoff : string;
  attribute hw_handoff of U0 : label is "block_encoder.hwdef";
begin
U0: entity work.encoder_test_block_encoder_0_0_block_encoder
     port map (
      clk => clk,
      enable => enable,
      encoder_a => encoder_a,
