...
--               /home/jacob/Documents/Semester4/Semesterprojekt_4/FPGA_projekt/FPGA_projekt.gen/sources_1/bd/pwm_generator/ip/pwm_generator_counter_1_0/pwm_generator_counter_1_0_sim_netlist.vhdl
...
entity pwm_generator_counter_1_0_counter is
  port (
  ...
  attribute ORIG_REF_NAME of pwm_generator_counter_1_0_counter : entity is "counter";
end pwm_generator_counter_1_0_counter;

architecture STRUCTURE of pwm_generator_counter_1_0_counter is
  ...
  signal \cnt_int_reg[23]_i_1_n_0\ : STD_LOGIC;
  signal \cnt_int_reg[23]_i_1_n_1\ : STD_LOGIC;
  signal \cnt_int_reg[23]_i_1_n_2\ : STD_LOGIC;
  signal \cnt_int_reg[23]_i_1_n_3\ : STD_LOGIC;
  signal \cnt_int_reg[23]_i_1_n_4\ : STD_LOGIC;
  signal \cnt_int_reg[23]_i_1_n_5\ : STD_LOGIC;
  signal \cnt_int_reg[23]_i_1_n_6\ : STD_LOGIC;
  signal \cnt_int_reg[23]_i_1_n_7\ : STD_LOGIC;
  signal \cnt_int_reg[26]_i_2_n_2\ : STD_LOGIC;
  signal \cnt_int_reg[26]_i_2_n_3\ : STD_LOGIC;
  signal \cnt_int_reg[26]_i_2_n_5\ : STD_LOGIC;
  signal \cnt_int_reg[26]_i_2_n_6\ : STD_LOGIC;
  signal \cnt_int_reg[26]_i_2_n_7\ : STD_LOGIC;
  ...
  signal \NLW_cnt_int_reg[26]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_cnt_int_reg[26]_i_2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute ADDER_THRESHOLD of \cnt_int_reg[23]_i_1\ : label is 11;
  attribute ADDER_THRESHOLD of \cnt_int_reg[26]_i_2\ : label is 11;
...
\cnt_int[26]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\cnt_int_reg[23]\: unisim.vcomponents.FDCE
    generic map(
      ...
      CE => sel,
      CLR => rst,
      D => \cnt_int_reg[23]_i_1_n_4\,
      Q => \^cnt\(23)
    );
\cnt_int_reg[23]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \cnt_int_reg[19]_i_1_n_0\,
      CO(3) => \cnt_int_reg[23]_i_1_n_0\,
      CO(2) => \cnt_int_reg[23]_i_1_n_1\,
      CO(1) => \cnt_int_reg[23]_i_1_n_2\,
      CO(0) => \cnt_int_reg[23]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \cnt_int_reg[23]_i_1_n_4\,
      O(2) => \cnt_int_reg[23]_i_1_n_5\,
      O(1) => \cnt_int_reg[23]_i_1_n_6\,
      O(0) => \cnt_int_reg[23]_i_1_n_7\,
...
\cnt_int_reg[26]\: unisim.vcomponents.FDCE
    generic map(
      ...
      CE => sel,
      CLR => rst,
      D => \cnt_int_reg[26]_i_2_n_5\,
      Q => \^cnt\(26)
    );
\cnt_int_reg[26]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => \cnt_int_reg[23]_i_1_n_0\,
      CO(3 downto 2) => \NLW_cnt_int_reg[26]_i_2_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \cnt_int_reg[26]_i_2_n_2\,
      CO(0) => \cnt_int_reg[26]_i_2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_cnt_int_reg[26]_i_2_O_UNCONNECTED\(3),
      O(2) => \cnt_int_reg[26]_i_2_n_5\,
      O(1) => \cnt_int_reg[26]_i_2_n_6\,
      O(0) => \cnt_int_reg[26]_i_2_n_7\,
      S(3) => '0',
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity pwm_generator_counter_1_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
    en : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of pwm_generator_counter_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of pwm_generator_counter_1_0 : entity is "pwm_generator_counter_1_0,counter,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of pwm_generator_counter_1_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of pwm_generator_counter_1_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of pwm_generator_counter_1_0 : entity is "counter,Vivado 2023.2";
end pwm_generator_counter_1_0;

architecture STRUCTURE of pwm_generator_counter_1_0 is
...
begin
U0: entity work.pwm_generator_counter_1_0_counter
     port map (
      clk => clk,
      cnt(26 downto 0) => cnt(26 downto 0),
      en => en,
