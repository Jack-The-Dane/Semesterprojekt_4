...
#
# Script generated by Vivado on Mon Apr 15 10:30:20 CEST 2024
...
#
# Usage        : SPI.sh
#                SPI.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SPI.sh [-reset_run]
#                SPI.sh [-reset_log]
#                SPI.sh [-help]
#
...
# script info
echo -e "SPI.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SPI.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SPI.wdb xsim.dir libdpi.so)
...
Usage: SPI.sh [-reset_log]\n\
Usage: SPI.sh [-keep_index]\n\
