...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.SPI -o SPI_simv
}
...
reset_run()
{
  files_to_remove=(ucli.key SPI_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc SPI_simv.daidir vcs_lib c.obj)
