...
#
# Script generated by Vivado on Tue May 14 09:23:31 CEST 2024
...
#                script (type 'buildup.sh -help' for more information).
#
...
design_libs_elab="-libname xil_defaultlib -libname xlconstant_v1_1_8 -libname xlconcat_v2_1_5 -libname xlslice_v1_0_3 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xil_defaultlib xlconstant_v1_1_8 xlconcat_v2_1_5 xlslice_v1_0_3)
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.buildup xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.buildup -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jacob/Documents/Semester4/Semesterprojekt_4/FPGA_projekt/FPGA_projekt.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log buildup_sc.so .tmp_log xcelium_lib waves.shm c.obj)
