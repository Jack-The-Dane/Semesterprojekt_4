...
design_libs=(xil_defaultlib xlconstant_v1_1_8 xlconcat_v2_1_5 xlslice_v1_0_3)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.buildup xil_defaultlib.glbl -o buildup_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./buildup_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key buildup_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc buildup_simv.daidir vcs_lib c.obj)
