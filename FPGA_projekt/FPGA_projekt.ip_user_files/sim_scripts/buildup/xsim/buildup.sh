...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xlconstant_v1_1_8 -L xlconcat_v2_1_5 -L xlslice_v1_0_3 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot buildup xil_defaultlib.buildup xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim buildup -key {Behavioral:sim_1:Functional:buildup} -tclbatch cmd.tcl -protoinst "protoinst_files/buildup.protoinst" -protoinst "protoinst_files/encoder_test.protoinst" -log simulate.log
}
