...
#
# Script generated by Vivado on Mon Apr 15 10:45:42 CEST 2024
...
#
# Usage        : buildup.sh
#                buildup.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                buildup.sh [-reset_run]
#                buildup.sh [-reset_log]
#                buildup.sh [-help]
#
...
# script info
echo -e "buildup.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./buildup.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xlconstant_v1_1_8 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot buildup xil_defaultlib.buildup xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim buildup -key {Behavioral:sim_1:Functional:buildup} -tclbatch cmd.tcl -protoinst "protoinst_files/buildup.protoinst" -protoinst "protoinst_files/SPI.protoinst" -protoinst "protoinst_files/encoder_sample.protoinst" -protoinst "protoinst_files/encoder_test.protoinst" -protoinst "protoinst_files/block_encoder.protoinst" -protoinst "protoinst_files/encoder_bd.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb buildup.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./buildup.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: buildup.sh [-help]\n\
Usage: buildup.sh [-step]\n\
Usage: buildup.sh [-lib_map_path]\n\
Usage: buildup.sh [-reset_run]\n\
Usage: buildup.sh [-reset_log]\n\
Usage: buildup.sh [-keep_index]\n\
Usage: buildup.sh [-noclean_files]\n\n\
