...
#                script (type 'block_encoder.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.block_encoder -o block_encoder_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./block_encoder_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jacob/Documents/Semester4/Semesterprojekt_4/FPGA_projekt/FPGA_projekt.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key block_encoder_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc block_encoder_simv.daidir vcs_lib c.obj)
