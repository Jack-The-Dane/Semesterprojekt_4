...
#
# Script generated by Vivado on Fri Apr 05 20:06:35 CEST 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : block_encoder.sh
...
#
# Usage        : block_encoder.sh
#                block_encoder.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                block_encoder.sh [-reset_run]
#                block_encoder.sh [-reset_log]
#                block_encoder.sh [-help]
#
...
# script info
echo -e "block_encoder.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./block_encoder.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot block_encoder xil_defaultlib.block_encoder -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim block_encoder -key {Behavioral:sim_1:Functional:block_encoder} -tclbatch cmd.tcl -protoinst "protoinst_files/block_encoder.protoinst" -protoinst "protoinst_files/encoder_sample.protoinst" -protoinst "protoinst_files/encoder_bd.protoinst" -protoinst "protoinst_files/pwm_generator.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb block_encoder.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./block_encoder.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: block_encoder.sh [-help]\n\
Usage: block_encoder.sh [-step]\n\
Usage: block_encoder.sh [-lib_map_path]\n\
Usage: block_encoder.sh [-reset_run]\n\
Usage: block_encoder.sh [-reset_log]\n\
Usage: block_encoder.sh [-keep_index]\n\
Usage: block_encoder.sh [-noclean_files]\n\n\
